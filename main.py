...
from algo import find_orange, new_algo_find, find_nearest_safe_food
...
go_to_snakes = []
for snake in gs.snakes:
    print(f"id snake {snake.id} snake status {snake.status} snake length {len (snake.geometry)} snake cord = {snake.geometry}")
